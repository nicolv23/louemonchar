...
namespace Projet_Final.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClientId,Nom,Prénom,Adresse,NuméroTéléphone")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClientId,Nom,Prénom,Adresse,NuméroTéléphone")] Client client)
        {
